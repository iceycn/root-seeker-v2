...
- 定义 channel id/capabilities/inbound/outbound/status

## 验收标准

- 告警平台和机器人都能抽象为 channel
...
- `01-定义-channel-id-capabilities-inbound-o.md`：定义 channel id/capabilities/inbound/outbound/status
