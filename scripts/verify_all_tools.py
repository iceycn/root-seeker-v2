...
def main() -> None:
    ...
    cases: list[tuple[str, dict[str, Any], str]] = [
        ...
        ("graph.impact", {"symbol": "PopRecordService.insertPopRecordLogic", "direction": "upstream"}, "graph"),
        ("graph.context", {"symbol": "PopRecordService.insertPopRecordLogic"}, "graph"),
        ("graph.query", {"search_query": "insert pop record"}, "graph"),
        ("graph.list_repos", {}, "graph"),
