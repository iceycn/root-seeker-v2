...
- `01-定义-SkillSpec.md`：定义 SkillSpec
- `02-定义-SkillCondition.md`：定义 SkillCondition
- `03-定义-SkillStepDefinition.md`：定义 SkillStepDefinition
- `04-定义-SkillExecutionPlan-与-GeneratedSki.md`：定义 SkillExecutionPlan 与 GeneratedSkillDraft
