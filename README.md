...
> **当前阶段**（`v1.2.0`）：MVP 主链路已在开发环境端到端跑通；Admin 已支持登录与用户管理。详见 [实现状态](docs/implementation-status.md)。问题与建议欢迎提 [Issue](https://github.com/iceycn/root-seeker-v2/issues)。
...
- [v1.2.0 发布说明](docs/releases/v1.2.0.md) · [v1.1.4 发布说明](docs/releases/v1.1.4.md) · [v1.1.3 发布说明](docs/releases/v1.1.3.md) · [v1.1.2 发布说明](docs/releases/v1.1.2.md) · [v1.1.1 发布说明](docs/releases/v1.1.1.md) · [v1.1.0 发布说明](docs/releases/v1.1.0.md)
