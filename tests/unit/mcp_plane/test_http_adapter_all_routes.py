...
def test_http_adapter_every_method_hits_expected_route(
    ...
    expectations: list[tuple[str, Any, tuple, dict, str, str]] = [
        ...
        ("graph_impact", adapter.graph_impact, ({"symbol": "A.b"},), {}, "POST", "/graph/impact"),
        ("graph_context", adapter.graph_context, ({"symbol": "A.b"},), {}, "POST", "/graph/context"),
        ("graph_query", adapter.graph_query, ({"search_query": "auth"},), {}, "POST", "/graph/query"),
        ("graph_cypher", adapter.graph_cypher, ({"query": "MATCH (n) RETURN n"},), {}, "POST", "/graph/cypher"),
        ("graph_trace", adapter.graph_trace, ({"source": "a", "target": "b"},), {}, "POST", "/graph/trace"),
        ("graph_list_repos", adapter.graph_list_repos, ({},), {}, "POST", "/graph/list_repos"),
        ("graph_detect_changes", adapter.graph_detect_changes, ({},), {}, "POST", "/graph/detect_changes"),
        ...
        ("repo_sync_changed", adapter.repo_sync_changed, ({"trigger_index": False},), {}, "POST", "/repos/sync-changed"),
...
def test_gateway_with_http_adapter_invokes_all_non_incident_tools(
    ...
    cases: list[tuple[str, dict[str, Any], str]] = [
        ...
        ("graph.impact", {"symbol": "A.b"}, "/graph/impact"),
        ("graph.context", {"symbol": "A.b"}, "/graph/context"),
        ("graph.query", {"search_query": "x"}, "/graph/query"),
        ("graph.cypher", {"query": "MATCH (n) RETURN n"}, "/graph/cypher"),
        ("graph.trace", {"source": "a", "target": "b"}, "/graph/trace"),
        ("graph.list_repos", {}, "/graph/list_repos"),
        ("graph.detect_changes", {}, "/graph/detect_changes"),
        ...
        ("repo.sync_changed", {}, "/repos/sync-changed"),
